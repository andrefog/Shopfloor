*----------------------------------------------------------------------*
***INCLUDE Z_LP_PP_SF_REPORT_CNTRL_O01.
*----------------------------------------------------------------------*
*&---------------------------------------------------------------------*
...
FORM get_dates  CHANGING it_date TYPE STANDARD TABLE.
  DATA: ls_cntrl TYPE ZABSF_PP_s_reports_cntrl,
        ls_date  TYPE ty_date.
...
*Get dates in internal table
  LOOP AT gt_cntrl INTO ls_cntrl.
    MOVE ls_cntrl-data TO ls_date-data.
...
*  Abbreviation for day
    CASE ls_date-day.
      WHEN 1. "Monday
        ls_date-tday = text-001.
      WHEN 2. "Tuesday
        ls_date-tday = text-002.
      WHEN 3. "Wednesday
