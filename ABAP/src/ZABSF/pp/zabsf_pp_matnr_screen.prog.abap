*&---------------------------------------------------------------------*
*&  Include           Z_LP_PP_SF_MATNR_SCREEN
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*&  Selection Screen
*&---------------------------------------------------------------------*
...
PARAMETERS: pa_prod  RADIOBUTTON GROUP r1 USER-COMMAND radio DEFAULT 'X',
            pa_stop  RADIOBUTTON GROUP r1,
            pa_scrap RADIOBUTTON GROUP r1,
            pa_rewrk RADIOBUTTON GROUP r1.
